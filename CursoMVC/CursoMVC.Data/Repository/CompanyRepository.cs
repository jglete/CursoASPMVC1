namespace CursoMVC.Data.Repository
{
    ...
    public class CompanyRepository : Repository<CursoMVC.Domain.Company>, Domain.Contracts.ICompanyRepository
    {
        ...
        public void AddInvoice(CursoMVC.Domain.Invoice Invoice)
        {
        }
